      ...
      <div className="container">
        <motion.div {...fadeUp} className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            ...
            No Gree AI flips that - catching the scam at the moment it lands in
            your inbox.
          </p>
        </motion.div>
        ...
        <div className="overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/10 via-card to-card p-10 sm:p-14">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <motion.p {...fadeUp} className="mt-4 text-muted-foreground">
              ...
              millions of messages - No Gree AI scales with you.
            </motion.p>
          </div>
          ...
          <p className="mt-10 text-center text-sm text-muted-foreground">
            🔒 No Gree AI never asks for your BVN, OTP, PIN or bank password.
          </p>
        </div>
      </div>
    </section>
